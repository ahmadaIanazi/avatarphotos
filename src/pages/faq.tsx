...
const Faq = () => {
  return (
    <PageContainer>
      ...
      >
        <Text fontFamily="Noto Sans Arabic" fontWeight="bold" fontSize="3xl">
          الأسئلة الشائعة
        </Text>

        <Text fontFamily="Noto Sans Arabic" fontWeight="bold" fontSize="xl">
          📸 What kind of photos should I upload to the platform?
        </Text>
        <Text fontFamily="Noto Sans Arabic">
